...
List<Event> demo_events = [
  ...
  Event(title: "Techne Summit 3", description: "this is an event", logo: "http://178.62.201.95/storage/events/1653667503-ticcket_launch.png", startAt: DateFormat.yMMM().format(DateTime(2022)), endAt: DateFormat.yMMM().format(DateTime(2022))),
  Event(title: "Techne Summit 3", description: "this is an event", logo: "http://178.62.201.95/storage/events/1653069980-turing_point.png", startAt: DateFormat.yMMM().format(DateTime(2022)), endAt: DateFormat.yMMM().format(DateTime(2022))),
  Event(title: "Techne Summit 3", description: "this is an event", logo: "http://178.62.201.95/storage/events/1653069980-turing_point.png", startAt: DateFormat.yMMM().format(DateTime(2022)), endAt: DateFormat.yMMM().format(DateTime(2022))),
  Event(title: "Techne Summit 3", description: "this is an event", logo: "http://178.62.201.95/storage/events/1653294320-event_gamed.jpg", startAt: DateFormat.yMMM().format(DateTime(2022)), endAt: DateFormat.yMMM().format(DateTime(2022))),
  Event(title: "Techne Summit 3", description: "this is an event", logo: "http://178.62.201.95/storage/events/1653069980-turing_point.png", startAt: DateFormat.yMMM().format(DateTime(2022)), endAt: DateFormat.yMMM().format(DateTime(2022))),
  Event(title: "Techne Summit 3", description: "this is an event", logo: "http://178.62.201.95/storage/events/1653069980-turing_point.png", startAt: DateFormat.yMMM().format(DateTime(2022)), endAt: DateFormat.yMMM().format(DateTime(2022))),
  Event(title: "Techne Summit 3", description: "this is an event", logo: "http://178.62.201.95/storage/events/1653294320-event_gamed.jpg", startAt: DateFormat.yMMM().format(DateTime(2022)), endAt: DateFormat.yMMM().format(DateTime(2022))),
  Event(title: "Techne Summit 3", description: "this is an event", logo: "http://178.62.201.95/storage/events/1653069980-turing_point.png", startAt: DateFormat.yMMM().format(DateTime(2022)), endAt: DateFormat.yMMM().format(DateTime(2022))),

...
class _EventScreenState extends State<EventScreen> {
  ...
  assign() async {
    user = await Global.getUser();
    organizers =  await Global.getOrganizers(widget.event.id);
    isBooked = await Global.isBooked(widget.event.id);
  }
    ...
    return Padding(
      ...
      child: ListView(
        ...
        children: [
          ...
          organizers.contains(this.user!.id) ?
          ElevatedButton(
            onPressed: () {
          ...
          }, child: const Text("Scan Tickets")) : Container(),
          widget.event.creator == this.user!.id ?
          Center(
            child: TextButton(
